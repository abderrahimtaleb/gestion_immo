...
$("#SelectFiliere").change(function(e)
{
  ...
  if(filiere != '')
  {
    $idFiliere=filiere; $("#NomFiliere").text('La filière '+$('#SelectFiliere option:selected').text());
        ...
        $.ajax({
          url : 'class/afficheEmploie_ct.php',
          type : 'POST',
          ...
          { 
            ...
            error : function(resultat, statut, erreur){
                alert('Veuillez ressayer ulterieurement 1 '+resultat[1]+' '+statut+' '+erreur);
          }
        });
      }else 
...
{
        $.ajax({
          url : 'controle/getDataLocale_ct.php',
          type : 'post',
...
var $url='';
  if(! $("#validerPeriode").hasClass("btn-success"))
{$url='controle/insertData_ct.php';}
else{$url='controle/updateData_ct.php';}
